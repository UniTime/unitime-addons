 ...
 *
 */
public class ColleagueSectionUpdateExport extends BaseCollegueSectionExport {

	/**
	 * 
	 */
	public ColleagueSectionUpdateExport() {
		// do nothing
	}
	...
	public void saveXml(Document document, Session session,
		...
		ColleagueMessage cm = new ColleagueMessage(acadSession, MessageAction.UPDATE, false, getHibSession(), document);
		addAllColleagueSections(cm, MessageAction.UPDATE, acadSession);
		commitTransaction();
