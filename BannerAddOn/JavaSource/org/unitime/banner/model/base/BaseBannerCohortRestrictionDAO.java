...
import org.unitime.banner.model.dao.BannerCohortRestrictionDAO;

/**
 * Do not change this class. It has been automatically generated using ant create-model.
 * @see org.unitime.commons.ant.CreateBaseModelFromXml
 */
public abstract class BaseBannerCohortRestrictionDAO extends _RootDAO<BannerCohortRestriction,Long> {
	...
	public List<BannerCohortRestriction> findByCohort(org.hibernate.Session hibSession, Long cohortId) {
		return hibSession.createQuery("from BannerCohortRestriction x where x.cohort.uniqueId = :cohortId").setLong("cohortId", cohortId).list();
	}
}
