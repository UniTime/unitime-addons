 ...
 */
public abstract class BaseBannerLastSentSectionRestrictionDAO extends _RootDAO<BannerLastSentSectionRestriction,Long> {
	...
	public List<BannerLastSentSectionRestriction> findByBannerSection(org.hibernate.Session hibSession, Long bannerSectionId) {
		return hibSession.createQuery("from BannerLastSentSectionRestriction x where x.bannerSection.uniqueId = :bannerSectionId").setLong("bannerSectionId", bannerSectionId).list();
	}
}
