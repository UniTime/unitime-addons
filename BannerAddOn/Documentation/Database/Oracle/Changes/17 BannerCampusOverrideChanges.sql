...
alter table banner_campus_override add replace_campus_code number(1,0);
...
alter table banner_campus_override add campus_code_regex varchar2(100 char);
alter table banner_campus_override add sequence_order number(10,0);
