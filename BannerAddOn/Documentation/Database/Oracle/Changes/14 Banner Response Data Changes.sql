...
alter table banner_response add session_id number(20);
alter table banner_response add subject_area_id number(20);
alter table banner_response add banner_section_id number(20);
alter table banner_response add campus varchar2(5 char);
